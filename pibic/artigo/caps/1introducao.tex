...
% ----------------------------------------------------------
A aplicação de técnicas de verificação formal em sistemas baseados em Inteligência Artificial (IA) tem se tornado crucial para garantir a confiabilidade desses modelos em ambientes críticos \cite{huang2017robustness}. Este trabalho apresenta uma abordagem utilizando o ESBMC (\textit{Efficient SMT-Based Context-Bounded Model Checker}) para a verificação de propriedades de segurança em redes neurais \cite{gopinath2021verifying} e sistemas de controle neuro-simbólicos.
