...
% Carregue bibliotecas TikZ no preambulo: carrega-las dentro de figuras cria
% definicoes locais que se perdem, embora o loader as marque como carregadas.
