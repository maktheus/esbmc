...
% ---
\titulo{Verificação Formal de Sistemas de Inteligência Artificial Generativa e Controladores Neurais utilizando ESBMC}
...
% TODO(autor): preencher antes da defesa -- placeholder do template abnTeX2
\primeiroexaminador{Prof. Me. Nome Completo da Pessoa}
\dadosprimeiroexaminador{Examinador interno (CCHE/UEPB)} % TODO: instituicao errada -- e UFAM
% TODO(autor): preencher antes da defesa -- placeholder do template abnTeX2
\segundoexaminador{Prof. Dra. Nome Completo da Pessoa}
\dadossegundoexaminador{Examinador interno (CCHE/UEPB)} % TODO: instituicao errada -- e UFAM
\datadefesa{27/06/2026}
