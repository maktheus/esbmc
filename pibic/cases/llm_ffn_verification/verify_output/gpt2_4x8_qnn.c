 ...
 *
 * Verify:
 *   esbmc gpt2_4x8_qnn.c --no-unwinding-assertions --boolector
 *
...
int main(void) {
    ...
    __ESBMC_assert(out0 >= -35 && out0 <= 35, "P1: output[0] out of bound");
    __ESBMC_assert(out1 >= -35 && out1 <= 35, "P1: output[1] out of bound");
    __ESBMC_assert(out2 >= -35 && out2 <= 35, "P1: output[2] out of bound");
    __ESBMC_assert(out3 >= -35 && out3 <= 35, "P1: output[3] out of bound");
